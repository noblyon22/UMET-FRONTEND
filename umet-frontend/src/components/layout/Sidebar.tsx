...
const Sidebar: React.FC = () => (
  <aside className="hidden md:flex flex-col w-56 min-h-screen bg-navy-900 text-white py-6">
    {/* Branding */}
    <div className="px-6 mb-8 border-b border-navy-800 pb-6">
      <p className="font-serif text-base font-bold text-white leading-tight">UMET</p>
      <p className="text-[10px] font-normal text-gold-400 tracking-widest uppercase mt-0.5">
        Expense Tracker
      </p>
    </div>
